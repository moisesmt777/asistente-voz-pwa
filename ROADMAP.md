...
> · **Almacenamiento y carga de modelos (v1.9.1):** el Service Worker deja de duplicar los pesos de los modelos (los gestionan WebLLM/Transformers.js/vits‑web), se pide **almacenamiento persistente** para que el sistema no borre lo descargado, los mensajes distinguen «descargando» de «preparando desde la memoria», hay interruptor de autocarga al iniciar (con preparación perezosa al primer mensaje) e info de espacio usado en Ajustes.
